...
public class LOGIN_WINDOW extends javax.swing.JFrame {
    ...
    public LOGIN_WINDOW() {
        ...
        jLabel_Image.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/13.png")));
        jLabel_Icon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/15.png")));
         Border title_border = BorderFactory.createMatteBorder(0, 0, 3,0, Color.BLACK);
        jLabel_Title.setBorder(title_border);
        Border image_border = BorderFactory.createMatteBorder(0, 0, 0,1, Color.BLACK);
        jPanel_Image.setBorder(image_border);
    ...
    private void initComponents() {
        ...
        jPanel_Image.setBackground(new java.awt.Color(240, 230, 140));
        ...
        jPanel_ImageLayout.setHorizontalGroup(
            ...
            .addComponent(jLabel_Image, javax.swing.GroupLayout.DEFAULT_SIZE, 300, Short.MAX_VALUE)
        );
        ...
        jLabel_Title.setText("LOAN CALCULATOR");
        ...
        jLabel3.setText("- Housing Loan");

        jLabel4.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(102, 102, 102));
        jLabel4.setText("- Personal Loan");

        jLabel_Icon.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED, new java.awt.Color(102, 102, 102), new java.awt.Color(102, 102, 102)));
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(jLabel_Icon, javax.swing.GroupLayout.DEFAULT_SIZE, 85, Short.MAX_VALUE)
                .addGap(13, 13, 13))
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        LoanAssistant s = new LoanAssistant();
        s.setVisible(true);
        dispose();
